...
import SeyahatSagilikInsurancePage from "@/components/Pages/InsurancePages/SeyahatSagilikInsurancePage/SeyahatSagilikInsurancePage";
import { SeyahatSaglikInsuranceStepsProvider } from "@/contexts/InsuranceStepsContexts/SehayatSagilikInsuranceContext";
...
function SeyagatSagilik(props: any) {
  const t = useTrans();
  ...
  return (
    ...
    // >
    <SeyahatSaglikInsuranceStepsProvider 
    branchId="T"
    productId="SYHT"
    productTarifId="74"
    ...
    paymentTypeId="H"
      >
      <SeyahatSagilikInsurancePage />
    </SeyahatSaglikInsuranceStepsProvider>
    // </main>
  );
}

SeyagatSagilik.getLayout = function getLayout(page: ReactElement) {
  return <ClientLayout>{page}</ClientLayout>;
};

export default SeyagatSagilik;
