...
function YabanciSagilikInsurance(props: any) {
  ...
  return (
    ...
    // >
    <YabanciSagilikInsuranceStepsProvider 
      yabanciSagilikProduct={props?.yabanciSagilikProduct}
      yabanciSagilikPesinPlan={props?.yabanciSagilikPesinPlan}
      >
      <YabanciSagilikInsurancePage />
    </YabanciSagilikInsuranceStepsProvider>
    // </main>
  );
}
