...
interface YabanciSagilikInfoFormThirdStepPropsType {
  handleNextStep: () => void;
...
const YabanciSagilikInfoFormThirdStep: FC<
  YabanciSagilikInfoFormThirdStepPropsType
> = (props) => {
  const { handleNextStep, goToTheNextStep } = props;
  const { setStepsValidation, values, setValues, setStepsSubmitButtons, isLoading } =
...
export default YabanciSagilikInfoFormThirdStep;
