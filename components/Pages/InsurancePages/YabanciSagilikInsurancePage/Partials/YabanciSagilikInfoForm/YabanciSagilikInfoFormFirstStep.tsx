...
interface YabanciSagilikInfoFormFirstStepPropsType {
  handleNextStep: () => void;
...
const YabanciSagilikInfoFormFirstStep: FC<
  YabanciSagilikInfoFormFirstStepPropsType
> = (props) => {
  ...
  const form = UiUseForm({
    ...
    validate: {
      ownerIdNumber: (value) =>
         value?.length < 2 ? "Pasaport Numarası Hatalıdır" : null,
  ...
  const parseTheDate = (inputString: string) => {
    ...
    // console.log('this is the e: ', inputString)
    ...
    // const month = parseInt(inputString.substring(2, 4), 10) - 1; // Months are 0-indexed
    // const year = parseInt(inputString.substring(4, 8), 10);
...
export default YabanciSagilikInfoFormFirstStep;
