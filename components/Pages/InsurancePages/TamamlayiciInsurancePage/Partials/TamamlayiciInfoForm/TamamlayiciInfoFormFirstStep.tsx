...
interface TamamlayiciInfoFormFirstStepPropsType {
  handleNextStep: () => void;
...
const TamamlayiciInfoFormFirstStep: FC<
  TamamlayiciInfoFormFirstStepPropsType
> = (props) => {
  const { handleNextStep, goToTheNextStep } = props;
  const { setStepsValidation, values, setValues, setStepsSubmitButtons } = useTamamlayiciStepsContext();
...
export default TamamlayiciInfoFormFirstStep;
