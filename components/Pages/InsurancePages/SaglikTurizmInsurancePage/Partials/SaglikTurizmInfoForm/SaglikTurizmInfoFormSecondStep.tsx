...
interface SaglikTurizmInfoFormSecondStepPropsType {
  handleNextStep: () => void;
  goToNextStep: () => void;
...
const SaglikTurizmInfoFormSecondStep: FC<
SaglikTurizmInfoFormSecondStepPropsType
> = (props) => {
...
export default SaglikTurizmInfoFormSecondStep;
