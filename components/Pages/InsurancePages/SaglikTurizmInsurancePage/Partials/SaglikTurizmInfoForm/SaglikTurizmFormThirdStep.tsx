...
interface SaglikTurizmInfoFormThirdStepPropsType {
  handleNextStep: () => void;
  goToTheNextStep: () => void;
}


const SaglikTurizmInfoFormThirdStep: FC<
SaglikTurizmInfoFormThirdStepPropsType
> = (props) => {
...
export default SaglikTurizmInfoFormThirdStep;
