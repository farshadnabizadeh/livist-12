...
import HouseIcon from '@/assets/images/icons/house-icon-colorful.svg'
import HouseOnFire from '@/assets/images/icons/house-on-fire.svg'
...
const UiSagilikSigortaUrunleri = [
  {
    id: 0,
    label: 'DASK',
    value: '/urunler/dask-sigortasi',
    Icon: HouseIcon
  },
  {
    id: 1,
    label: 'Konut Sigortası',
    value: '/urunler/konut-sigortasi',
    Icon: HouseOnFire
  },
  {
    id: 0,
    label: 'Evim Güvende',
    value: '/urunler/evim-guvende',
    Icon: HouseWithCheckmark
  }
]



const KonutSigortasiPage = () => {
  return (
    <>
      <CategoriesPageHero
...
export default KonutSigortasiPage